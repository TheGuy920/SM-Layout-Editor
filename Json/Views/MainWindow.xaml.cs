...
namespace SM_Layout_Editor.Views
{
    ...
    public partial class MainWindow
    {
        ...
        {
            get { return "SM_Layout_Editor/Config"; }
        }
        ...
        {
            var updater = new ApplicationUpdater("SM_Layout_Editor.msi", GetType().Assembly, 
                "http://rsuter.com/Projects/SM_Layout_Editor/updates.php");
